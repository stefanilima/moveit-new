...
// Tipo do desafio presente no json
interface Challenge {
    type: 'body' | 'eye';
    description: string;
    amount: number;
...
export function ChallengesProvider({ children, ...rest }: ChallengesProviderProps) {
    ...
    // Dispara sempre que algumas das informacoes sao alteradas
    useEffect(() => {
    ...
    // Busca o desafio no json através de um randon
    ...
    // Zera o challenge como null
    function resetChallenge() {
        setActiveChallenge(null);
    }

    // Completa o desafio e sobe de nivel
